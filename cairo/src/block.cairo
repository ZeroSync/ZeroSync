...
from block_header import BlockHeaderValidationContext, read_block_header_validation_context
...
func read_transactions_validation_context{reader: Reader, range_check_ptr}(
	) -> (contexts: TransactionValidationContext*):
	let contexts: TransactionValidationContext* = alloc()
	# _read_transactions_validation_context_loop(contexts, transactions_count)
	return (contexts)
end

func _read_transactions_validation_context_loop{reader: Reader, range_check_ptr}(
