...
from src.buffer import flush_writer, init_writer, write_byte, write_bytes4, init_reader, read_byte, read_bytes4, read_bytes4_endian, read_bytes
...
@external
func test_read_n_bytes{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}():
    alloc_locals
