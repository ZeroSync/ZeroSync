...
func dummy_utxo_insert_batch{hash_ptr: HashBuiltin*, utreexo_roots: felt*}(hashes: felt*, hashes_end: felt*) {
...
func dummy_utxo_insert_block_number{hash_ptr: HashBuiltin*, utreexo_roots: felt*}(block_number: felt) {
    alloc_locals;
