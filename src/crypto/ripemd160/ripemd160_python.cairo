...
func setup_python_ripemd160() {
    %{
        ...
        def _kg(x, y): return int(2**30 * (y ** (1.0 / x)))
        ...
        def _compress(h, x):    # x is a list of 16 x 32-bit words
            ...
            # Iterate through all 5 rounds of the compression function for each
            # parallel pipeline
        ...
        class RIPEMD160(object):
            ...
            def digest(self):
                ...
                # The total length of the message in bits, modulo 2**64
