...
func test_utreexo_basics{range_check_ptr, pedersen_ptr: HashBuiltin*}() {
    ...
    with_attr error_message("utreexo_roots has invalid value in utreexo_basics test.") {
    ...
    with_attr error_message("Failed to assign values in inclusion_proof for utreexo_basics test.") {
...
func test_utreexo_inclusion{range_check_ptr, pedersen_ptr: HashBuiltin*}() {
    ...
    with_attr error_message("Failed to assign values in utreexo_roots for inclusion test.") {
    ...
    let (inclusion_proof) = alloc();
    with_attr error_message("Failed to assign values in inclusion_proof for inclusion test.") {
